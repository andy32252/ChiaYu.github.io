...
function getSelfIntroductionInfo(){
  db.collection("selfintroduction").get().then(function(querySnapshot) {
      var introduction = "";
...
function getSkillsInfo(){
  db.collection("Skills").get().then(function(querySnapshot) {
      var skillInfo = "<table>";
      querySnapshot.forEach(function(doc) {
          skillInfo += "<tr><td width=\"25%\" style=\"font-weight:bold;\">"+doc.data()["類別"]+"</td><td>"+doc.data()["項目"]+"</td></tr>";					
      });	
      skillInfo += "</table>";
...
function getCertificateInfo(){
  db.collection("Certification").get().then(function(querySnapshot) {
      var certificateInfo = "<table>";
      querySnapshot.forEach(function(doc) {
          certificateInfo += "<tr><td width=\"25%\" style=\"font-weight:bold;\">"+doc.data()["類別"]+"</td><td>"+doc.data()["項目"]+"</td></tr>";					
      });	
